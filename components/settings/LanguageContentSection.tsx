...
export default function LanguageContentSection() {
  ...
  return <div className="flex flex-col gap-8 p-4 sm:p-6">
    <section><div className="flex items-center gap-2"><Globe2 className="h-5 w-5 text-kelo-primary"/><h3 className="font-extrabold">Langue de Kelo Social</h3></div>
      <p className="mt-1 text-sm text-kelo-muted">Choisissez la langue d’affichage. Automatique utilise la langue de votre appareil.</p>
    ...
    <section className="border-t border-kelo-border pt-6"><div className="flex items-center gap-2"><Languages className="h-5 w-5 text-kelo-primary"/><h3 className="font-extrabold">Langues des publications</h3></div>
      <p className="mt-1 text-sm text-kelo-muted">Sélectionnez une ou plusieurs langues à privilégier dans votre fil. Sans sélection, toutes les langues restent autorisées.</p>
    ...
    <section className="border-t border-kelo-border pt-6"><div className="flex items-center gap-2"><Sparkles className="h-5 w-5 text-kelo-primary"/><h3 className="font-extrabold">Centres d’intérêt</h3></div>
      <p className="mt-1 text-sm text-kelo-muted">Ces choix permettent à Kelo Social de privilégier les publications qui correspondent à vos intérêts.</p>
