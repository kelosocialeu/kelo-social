    ...
    <nav className="w-full bg-white">
      {GROUPS.map((group) => (
        <section key={group.title} className="border-b border-kelo-border py-3 last:border-b-0">
          <h2 className="px-4 pb-2 text-xs font-bold uppercase tracking-wide text-kelo-muted sm:px-5">
            {group.title}
          </h2>
      ...
      <div className="border-t border-kelo-border px-4 py-4 text-xs text-kelo-muted sm:px-5">
