...
export default function LandingPage() {
  ...
  if (!checked || session) {
    return (
      <main className="flex min-h-[100dvh] items-center justify-center bg-gradient-to-br from-violet-50 via-white to-pink-50">
      ...
      <div className="mx-auto flex min-h-screen max-w-7xl flex-col items-center justify-center px-6">
        ...
        <div className="mt-16 grid max-w-5xl gap-6 md:grid-cols-3">
          <div className="rounded-3xl bg-white p-6 shadow-lg">
            ...
            <h3 className="text-lg font-bold">Fédération</h3>
            <p className="mt-2 text-sm text-gray-600">
              Compatible avec plusieurs PDS et l&apos;ensemble de l&apos;écosystème AT Protocol.
            </p>
          </div>
          ...
          <div className="rounded-3xl bg-white p-6 shadow-lg">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Les comptes peuvent être vérifiés grâce à Kelo ID et recevoir des badges de certification.
            </p>
          </div>

          <div className="rounded-3xl bg-white p-6 shadow-lg">
            <div className="mb-3 text-3xl">🚀</div>
            <h3 className="text-lg font-bold">Moderne</h3>
            <p className="mt-2 text-sm text-gray-600">
              Une interface rapide et pensée pour offrir une expérience agréable sur ordinateur comme sur mobile.
            </p>
          </div>
        </div>
      </div>
